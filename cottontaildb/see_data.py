...
with CottontailDBClient('localhost', 1865) as client:
    ...
    #result = client.select("tal_db", "text_search",["video_id", "keyframe_id", "tesseract_text", "start_time", "image_capture_text"]
    #result = client.select("tal_db", "video_search",["video_id", "vimeo_id"])
